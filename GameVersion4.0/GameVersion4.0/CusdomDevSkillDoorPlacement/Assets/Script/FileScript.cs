    ...
    public static void createXML()
    {
        if (flag)
        {
            ...
            flag = false;
				...
				WebRequest request = WebRequest.Create("http://crowdevac.com/store_data.php?scene="+SceneManager.GetActiveScene().name);
				request.Method="GET";
				...
				request = WebRequest.Create("http://crowdevac.com/store_data.php?scene="+SceneManager.GetActiveScene().name+"&querystring="+xml);
				request.Method="POST";
